export const cyclePresets = [
  {
    prompt: <>
              <p>Take a moment to centre yourself in the place you are logging on from, anchored by the pulse of the track.</p>
              <p>Draw or write about something you carry that relates to that place - a sensation, a thought, a memory, or something else.</p>
    ...
    trackDetails: <>a lightning ridge opal mine anxiety <em>by</em> amby downs</>,

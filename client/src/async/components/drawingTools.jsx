  ...
  return (
    <>
      <div id="drawing-buttons-wrapper">
        <button id="increase-brush-button" className="DrawingUIButton" onClick={() => {if(props.brushSize < 60){ props.setBrushSize(props.brushSize + 4) } else {props.setBrushSize(60)} }}> BRUSH + <div id="brush-up-icon" /></button>
        <button id="decrease-brush-button" className="DrawingUIButton" onClick={() => {if(props.brushSize > 2){ props.setBrushSize(props.brushSize - 4) } else { props.setBrushSize(2)} }}> BRUSH - <div id="brush-down-icon" /></button>
